...
public final class OnYourDataEncodedApiKeyAuthenticationOptions extends OnYourDataAuthenticationOptions {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("type", "encoded_api_key");
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    ...
                    if (!"encoded_api_key".equals(type)) {
                        throw new IllegalStateException(
                            "'type' was expected to be non-null and equal to 'encoded_api_key'. The found 'type' was '"
                                + type + "'.");
                    }
            ...
            return new OnYourDataEncodedApiKeyAuthenticationOptions(encodedApiKey);
        });
    }
}
