...
public final class ChatRequestToolMessage extends ChatRequestMessage {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("role", "tool");
    ...
    public static ChatRequestToolMessage fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
                ...
                if ("role".equals(fieldName)) {
                    ...
                    if (!"tool".equals(role)) {
                        throw new IllegalStateException(
                            "'role' was expected to be non-null and equal to 'tool'. The found 'role' was '" + role
                                + "'.");
                    }
            ...
            return new ChatRequestToolMessage(content, toolCallId);
        });
    }
}
