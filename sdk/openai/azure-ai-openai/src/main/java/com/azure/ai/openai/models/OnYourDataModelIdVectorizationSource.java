...
public final class OnYourDataModelIdVectorizationSource extends OnYourDataVectorizationSource {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("type", "model_id");
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    ...
                    if (!"model_id".equals(type)) {
                        throw new IllegalStateException(
                            "'type' was expected to be non-null and equal to 'model_id'. The found 'type' was '" + type
                                + "'.");
                    }
            ...
            return new OnYourDataModelIdVectorizationSource(modelId);
        });
    }
}
