...
public final class OnYourDataKeyAndKeyIdAuthenticationOptions extends OnYourDataAuthenticationOptions {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("type", "key_and_key_id");
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    ...
                    if (!"key_and_key_id".equals(type)) {
                        throw new IllegalStateException(
                            "'type' was expected to be non-null and equal to 'key_and_key_id'. The found 'type' was '"
                                + type + "'.");
                    }
            ...
            return new OnYourDataKeyAndKeyIdAuthenticationOptions(key, keyId);
        });
    }
}
