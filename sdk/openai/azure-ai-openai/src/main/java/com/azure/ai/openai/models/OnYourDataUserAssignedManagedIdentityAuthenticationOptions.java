...
public final class OnYourDataUserAssignedManagedIdentityAuthenticationOptions extends OnYourDataAuthenticationOptions {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("type", "user_assigned_managed_identity");
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    ...
                    if (!"user_assigned_managed_identity".equals(type)) {
                        throw new IllegalStateException(
                            "'type' was expected to be non-null and equal to 'user_assigned_managed_identity'. The found 'type' was '"
                                + type + "'.");
                    }
            ...
            return new OnYourDataUserAssignedManagedIdentityAuthenticationOptions(managedIdentityResourceId);
        });
    }
}
