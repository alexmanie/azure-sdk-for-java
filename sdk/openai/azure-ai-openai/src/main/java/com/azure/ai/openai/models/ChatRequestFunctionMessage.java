...
public final class ChatRequestFunctionMessage extends ChatRequestMessage {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("role", "function");
    ...
    public static ChatRequestFunctionMessage fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
                ...
                if ("role".equals(fieldName)) {
                    ...
                    if (!"function".equals(role)) {
                        throw new IllegalStateException(
                            "'role' was expected to be non-null and equal to 'function'. The found 'role' was '" + role
                                + "'.");
                    }
            ...
            return new ChatRequestFunctionMessage(name, content);
        });
    }
}
